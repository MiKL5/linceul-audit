...
`#01` 🗺️ [C4 — Contexte Système (L1)](systemContext/README.md)  
...
[`#10` 🧵 État — Virtual Thread (Pinning JNI)]()  
...
[`#29` 🔁 Automate d'États — Résilience Système](./docs/diagrams/29-state-system-resilience.md)  
...
[`#24` ⚖️ Matrice de Conformité Réglementaire]()  
...
[`#31` ✅ Matrice Traçabilité Tests ↔ User Stories]()  
